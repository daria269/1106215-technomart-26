...
* Студент: [Дарья Кравченко](https://up.htmlacademy.ru/htmlcss/26/user/1106215).
* Наставник: `Максим Непорада сказал мне что-то здесь поменять`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/1106215-technomart-26) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
